...
*/
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CUSTOMER', 'BARISTA', 'DATA_ANALYST', 'ADMIN', 'SUPERADMIN');

-- CreateEnum
CREATE TYPE "Category" AS ENUM ('COFFEE', 'PASTRY', 'MERCH');
...
CREATE TABLE "users" (
    ...
    "address" TEXT,
    "country" TEXT,
    "avatarColor" TEXT DEFAULT '795548',
...
-- CreateTable
CREATE TABLE "station_logistics" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    ...
    CONSTRAINT "station_logistics_pkey" PRIMARY KEY ("id")
);
